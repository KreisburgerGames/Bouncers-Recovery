...
public class ProcessStartInfo : IDisposable
{
	...
	[DllImport("KS_Diagnostics_Process")]
	static extern bool GetRedirectStandardInput(IntPtr p);

	[DllImport("KS_Diagnostics_Process")]
	static extern void SetRedirectStandardInput(IntPtr p, bool b);

	public bool RedirectStandardInput
	{
		get => GetRedirectStandardInput(ptr);
		set => SetRedirectStandardInput(ptr, value);
	}
